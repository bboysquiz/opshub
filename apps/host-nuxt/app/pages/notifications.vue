            ...
            <q-card flat bordered>
              ...
              <q-card-section class="q-gutter-y-sm">
                ...
                <q-banner rounded class="bg-blue-1 text-blue-9">
                  Чтобы push-уведомления показывались, проверь три условия: для сайта в браузере
                  должны быть разрешены уведомления, в настройках операционной системы должны быть
                  включены уведомления для браузера, а после изменения этих настроек страницу лучше
                  перезагрузить и подписаться заново.
                </q-banner>
              </q-card-section>
